...
class SocialBotDataset(InMemoryDataset):
    def __init__(self, root, transform=None, pre_transform=None,validation_ratio=0.5,test_ratio=0.9,dataset="botometer-feedback-2019",transer_y=False,KFold=10,K=0):
